...
module.exports = React.createClass({
            ...
            render: function() {
                ...
                return ( <
                    ...
                    <
                    p > {
                        _tJsx("Sorry, your browser is <b>not</b> able to run Riot.", /<b>(.*?)<\/b>/, (sub) => < b > { sub } < /b>) } </p >
                            <
                            p > { _t("Riot uses many advanced browser features, some of which are not available or experimental in your current browser.") } <
                            /p> <
                            p > {
                            ...
                            /p> <
                            p > { _t("With your current browser, the look and feel of the application may be completely incorrect, and some or all features may not function. If you want to try it anyway you can continue, but you are on your own in terms of any issues you may encounter!") } <
                            /p> <
                            button onClick = { this.onAccept } > { _t("I understand the risks and wish to continue") } <
                            /button> <
                            /div> <
                            /div>
                        );
