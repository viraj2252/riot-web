        ...
        _buttons() {
            ...
            render() {
                if (this.state.message) {
                    return <div >
                        <
                        div className = "mx_Dialog_content" > { this.state.message } <
                        /div> { this._buttons() } <
                        /div>;
                }
                ...
                return <div >
                    <
                    div className = "mx_Dialog_content" > { this._additionalFields() } <
                ...
                render() {
                        ...
                        if (this.state.eventType === null) {
                            Object.keys(this.roomStateEvents).forEach((evType) => {
                                    ...
                                    rows.push( < button className = "mx_DevTools_RoomStateExplorer_button"
                                        key = { evType }
                                        onClick = { onClickFn } > { evType } <
                                        /button>);
                                    });
                            }
                            else {
                                ...
                                Object.keys(stateGroup).forEach((stateKey) => {
                                        ...
                                        rows.push( < button className = "mx_DevTools_RoomStateExplorer_button"
                                            key = { stateKey }
                                            onClick = { this.onViewSourceClick(ev) } > { stateKey } <
                                            /button>);
                                        });
                                }
                                ...
                                return <div >
                                    <
                                    div className = "mx_Dialog_content" > { rows } <
                                    /div> <
                                    div className = "mx_Dialog_buttons" >
                                    <
                                    button onClick = { this.onBack } > { _t('Back') } < /button> <
                        ...
                        export default class DevtoolsDialog extends React.Component {
                            ...
                            render() {
                                ...
                                return <BaseDialog className = "mx_QuestionDialog"
                                onFinished = { this.props.onFinished }
                                title = { _t('Developer Tools') } >
                                    <
                                    div > Room ID: { this.props.roomId } < /div> { body } <
                                    /BaseDialog>;
                            }
                        }