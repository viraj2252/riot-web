...
var MatrixClientPeg = require('matrix-react-sdk-vj/lib/MatrixClientPeg');
var UserSettingsStore = require('matrix-react-sdk-vj/lib/UserSettingsStore');
var Modal = require('matrix-react-sdk-vj/lib/Modal');
...
module.exports = React.createClass({
                                ...
                                "description": ( <
                                    span > {
                                        _tJsx('Messages containing <span>keywords</span>',
                                            /<span>(.*?)<\/span>/,
                                            (sub) => {
                                                return <span className = "mx_UserNotifSettings_keywords"
                                                onClick = { self.onKeywordsClicked } > { sub } < /span>;
                                            }
                                        )
                                    } <
                                    /span>
            ...
            emailNotificationsRow: function(address, label) {
                    return ( < div className = "mx_UserNotifSettings_tableRow" >
                            ...
                            <
                            label htmlFor = "enableEmailNotifications_{address}" > { label } <
                            /label> <
                            /div> <
                            /div>);
                        },
                        ...
                        render: function() {
                            ...
                            if (this.state.masterPushRule) {
                                var masterPushRuleDiv = ( <
                                    ...
                                    div className = "mx_UserNotifSettings_labelCell" >
                                    <
                                    label htmlFor = "enableNotifications" > { _t('Enable notifications for this account') } <
                                    /label> <
                                    /div> <
                                    /div>
                                );
                            ...
                            if (this.state.masterPushRule && this.state.masterPushRule.enabled) {
                                return ( <
                                    div > { masterPushRuleDiv }

                                    <
                                    div className = "mx_UserSettings_notifTable" > { _t('All notifications are currently disabled for all targets.') }. <
                                    /div> <
                                    /div>
                                );
                            }
                            ...
                            if (emailThreepids.length === 0) {
                                emailNotificationsRow = < div > { _t('Add an email address above to configure email notifications') } <
                                    /div>;
                            } else {
                                    ...
                                    if (this.state.pushers === undefined) {
                                        ...
                                        for (var i = 0; i < this.state.pushers.length; ++i) {
                                            ...
                                            if (devicesSection) {
                                                devicesSection = ( < div >
                                                    <
                                                    h3 > { _t('Notification targets') } < /h3> { devicesSection } <
                                                    /div>);
                                                }
                                                ...
                                                if (externalRules.length) {
                                                    advancedSettings = ( <
                                                        div >
                                                        <
                                                        h3 > { _t('Advanced notification settings') } < /h3> { _t('There are advanced notifications which are not shown here') }. < br / > { _t('You might have configured them in a client other than Riot. You cannot tune them in Riot but they still apply') }. <
                                                        ul > { externalRules } <
                                                        /ul> <
                                                        /div>
                                                    );
                                                ...
                                                return ( <
                                                    ...
                                                    div className = "mx_UserNotifSettings_labelCell" >
                                                    <
                                                    label htmlFor = "enableDesktopNotifications" > { _t('Enable desktop notifications') } <
                                                    /label> <
                                                    /div> <
                                                    /div>
                                                    ...
                                                    div className = "mx_UserNotifSettings_labelCell" >
                                                    <
                                                    label htmlFor = "enableDesktopAudioNotifications" > { _t('Enable audible notifications in web client') } <
                                                    /label> <
                                                    /div> <
                                                    /div>
