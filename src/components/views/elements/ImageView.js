...
var DateUtils = require('matrix-react-sdk-vj/lib/DateUtils');
...
module.exports = React.createClass({
            ...
            render: function() {
                ...
                */
                ...
                var eventMeta;
                if (showEventMeta) {
                    eventMeta = ( < div className = "mx_ImageView_metadata" > { _t('Uploaded on %(date)s by %(user)s', { date: DateUtils.formatDate(new Date(this.props.mxEvent.getTs())), user: this.props.mxEvent.getSender() }) } <
                        /div>);
                    }

                    var eventRedact;
                    if (showEventMeta) {
                        eventRedact = ( < div className = "mx_ImageView_button"
                        ...
                        return ( <
                            ...
                            <
                            AccessibleButton className = "mx_ImageView_cancel"
                            onClick = { this.props.onFinished } > < img src = "img/cancel-white.svg"
                            width = "18"
                            height = "18"
                            alt = { _t('Close') }
                            /></AccessibleButton >
                            ...
                            /div> { eventMeta } <
                            a className = "mx_ImageView_link"
                            href = { this.props.src }
                            download = { this.props.name }
                            target = "_blank"
                            rel = "noopener" >
                            <
                            div className = "mx_ImageView_download" > { _t('Download this file') } < br / >
                            <
